...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Contact = new OpenApiContact
        {
            ...
            Email = "matheusrnascimento92@gmail.com",
            Url = new Uri("https://github.com/MatheusrNascimento?tab=repositories")
        },
        Description = "Api feita para estudos de Entity Fremework Core"
    });
